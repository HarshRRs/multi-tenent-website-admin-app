...
abstract class AppLocalizations {
  ...
  /// No description provided for @printConnect.
  ///
  /// In en, this message translates to:
  /// **'Connect Printer'**
  String get printConnect;

  /// No description provided for @printDisconnect.
  ///
  /// In en, this message translates to:
  /// **'Disconnect'**
  String get printDisconnect;
  ...
  /// No description provided for @printNoDevice.
  ///
  /// In en, this message translates to:
  /// **'No devices found'**
  String get printNoDevice;

  /// No description provided for @printConnected.
  ///
  /// In en, this message translates to:
  /// **'Connected'**
  String get printConnected;

  /// No description provided for @printDisconnected.
  ///
  /// In en, this message translates to:
  /// **'Disconnected'**
